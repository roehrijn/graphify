...
def infer_project_name(graph_path: str, meta: dict) -> str:
    ...
    if path.parent.name == _GRAPHIFY_OUT and len(path.parents) > 1:
...
def resolve_graphify_paths(args) -> dict:
    ...
    if args.graphify_out:
        ...
        graphify_out = base / _GRAPHIFY_OUT

    project_root = graphify_out.parent if graphify_out.name == _GRAPHIFY_OUT else base
